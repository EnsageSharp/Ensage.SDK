...
namespace Ensage.SDK.Orbwalker.Modes
{
    ...
    internal abstract class AttackOrbwalkingMode : AutoAttackMode
    {
        ...
        {
            this.Config = new AutoAttackModeConfig(this.Orbwalker.Config.Factory, this.name, this.key, this.hero, this.creep, this.neutral, this.building, this.deny, this.lasthit);
