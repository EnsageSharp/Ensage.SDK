...
namespace Ensage.SDK.Menu.Entries
{
    ...
    public class MenuEntry : MenuBase
    {
        ...
        public MenuEntry(string name, View view, IRenderManager renderer, MenuConfig menuConfig, object instance)
            : base(name, view, renderer, menuConfig, instance)
        {
        }

        public MenuEntry(string name, [CanBeNull] string textureKey, View view, IRenderManager renderer, MenuConfig menuConfig, object instance)
